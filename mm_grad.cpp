...
void ICoord::freeze(int natoms0, int* frz0)
{
...
double ICoord::ffbondd(int i, int j){
  ...
  if (anumbers[i]==1 && anumbers[j]==6)
    ...
    return 1.44;
  else if (anumbers[i]==15 && anumbers[j]==6)
    return 1.7;
  else if (anumbers[i]==6 && anumbers[j]==15)
    return 1.7; 
...
double ICoord::ffangled(int i, int j){
  ...
  if (anumbers[i]==1 && anumbers[j]==6)
    ...
    return 109;
  else if (anumbers[i]==7 && anumbers[j]==15)
    return 179;
  else if (anumbers[i]==15 && anumbers[j]==7)
    return 179;
  else
    return 109;
}
